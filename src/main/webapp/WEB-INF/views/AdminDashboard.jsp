<%--
    Document   : Dashboard
    Created on : Jan 1, 2017, 12:29:07 PM
    Author     : myhp
--%>
...
<head>
    ...
    <link rel="assets/stylesheet" type="text/css" href="css/maps/jquery-jvectormap-2.0.1.css" />
                                    ...
                                    <ul class="nav side-menu">
                                        <li><a><i class="fa fa-home"></i> Posts <span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: none">
                                                <li><a href="viewposts">All Posts</a>
                                                </li>
                                                <li><a href="#">Add New</a>
                                                </li>
                                        ...
                                        <li><a><i class="fa fa-table"></i> Service Provider Contacts <span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: none">
