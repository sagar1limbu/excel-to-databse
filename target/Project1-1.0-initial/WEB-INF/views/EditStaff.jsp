                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="editstaff" method="post">

                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="staffname" placeholder="Enter Staff Name" class="form-control" value="${staff.staff_name}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="examcenter" placeholder="Exam-Center" class="form-control" value="${staff.exam_center}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="time" placeholder="Time" class="form-control" value="${staff.time}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="date" placeholder="Date" class="form-control" value="${staff.date}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        <input type="hidden" name="id" placeholder="ID" class="form-control" value="${staff.staff_id}">
                                    </div>
